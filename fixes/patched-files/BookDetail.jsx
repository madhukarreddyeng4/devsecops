      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14, marginBottom: 32 }}>
        {reviews.map((r) => (
          <div key={r.id} className="card" style={{ padding: 18 }}>
            ...
            {/*
              [FIX-08] Stored XSS fixed: render the review body as a STRING
              child. React auto-escapes <, >, & so an injected
              <img onerror=...> shows up as harmless text instead of running.
              We no longer render review HTML directly — that was the bug.
            */}
